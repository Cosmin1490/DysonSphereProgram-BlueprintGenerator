...
class DSPBlueprintValidator:
    ...
    @staticmethod
    def validate_vertices(polyhedron, min_distance=0.00511225, tolerance=1e-9):
    ...
    @staticmethod
    def validate_polyhedron(polyhedron, min_distance=0.00511225, tolerance=1e-9):
        return DSPBlueprintValidator.validate_vertices(polyhedron, min_distance, tolerance)

    @staticmethod
    def correct_polyhedron(polyhedron, min_distance=0.00511225, tolerance=1e-9):
